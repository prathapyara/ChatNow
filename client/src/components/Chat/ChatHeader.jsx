...
function ChatHeader() {
  const [{currentChatUser,searchMessages,onlineUsers},dispatch]=useStateProvider();
  ...
  <div className="h-16 px-4 py-3 flex justify-between items-center bg-panel-header-background z-10">
    ...
    <div className="flex gap-6">
      ...
      <BiSearchAlt2 className="text-panel-header-icon cursor-pointer text-xl" onClick={()=>dispatch({type:reducerCases.SET_MESSAGE_SEARCH})} title="Search Messages"/>
